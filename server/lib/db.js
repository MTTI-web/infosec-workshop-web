    ...
    dbPromise = initSqlJs({
      ...
      db.run(`
        INSERT INTO users (username, password, is_hidden, secret_pin, post) VALUES
          ...
          ('admin', 'S3cr3t-Adm1n-Pass!', 1, '9999', 'After passing Aurora East Street, you notice a strange inscription carved into the wall. It says b11f9fa4e239b9c8fc708e5e9b470e25215e046201acf5cb22e1d4843b37c22a');
      `);
